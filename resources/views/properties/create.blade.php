...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="mb-0" style="font-size:1.1rem;font-weight:700;color:#1a1a2e">Add New Property</h2>
                <p class="text-muted mb-0" style="font-size:.8rem">Fill in the property details below</p>
            </div>
        </div>
                ...
                <form action="{{ route('properties.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-select @error('type') is-invalid @enderror">
                            ...
                            <option value="apartment"    {{ old('type') === 'apartment'    ? 'selected' : '' }}>Apartment Block</option>
                            <option value="maisonette"   {{ old('type') === 'maisonette'   ? 'selected' : '' }}>Maisonette</option>
                            <option value="bedsitter"    {{ old('type') === 'bedsitter'    ? 'selected' : '' }}>Bedsitter</option>
                            <option value="single_room"  {{ old('type') === 'single_room'  ? 'selected' : '' }}>Single Room</option>
                            <option value="double_room"  {{ old('type') === 'double_room'  ? 'selected' : '' }}>Double Room</option>
